// components/UserCard/UserCardContainer.jsx
...
export default function UserCardContainer() {
  ...
  return (
    <div className="flex flex-wrap gap-4 justify-center p-8">
      <UserCard userData={userData} handleClick={handleClick} />
      <UserCard userData={userData2} handleClick={handleClick} />
      <UserCard userData={userData3} handleClick={handleClick} />
    </div>
  );
}