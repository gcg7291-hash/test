...
const responseSchema = {
  ...
  required: ["content", "dueDate", "isMemo"],
  additionalProperties: false, // 구조를 못벗어나게 답변하게 만드는
};
...
// 응답 파라미터 설정
// const config = {
//   temperature: 0, // 0에 가까울수록 고정된 답변 (창의성 수준 0~1)
//   maxOutputTokens: 1000, // 응답 최대 토큰 수 ( 최대 8192?)
//   stopSequences: "\\n\\n",
//   // 시스템 지침 속성
//   systemInstruction: [
//     "당신은 전문 IT 개발자 입니다",
//     "오로지 JavaScript 개밸 개념에 대한 질문에만 답변한다",
//     "JavaScript 개발 개념 질문이 아니면 `답변 할 수 없습니다` 라고 답변한다",

//     //당신은 전문 할일 관리 분석가 업무 할일 메모와 관련된 질문에만 답변 그외 질문 할일과 관련 없습니다 라고 답변
//   ],
// };
